...
export const ANIMATIONS: LottieAnimation[] = [
  ...
  // — Generated flat-design characters —
  {
    id: 'jumping-jack-gen',
    name: 'Jumping Jacks',
    file: '/lottie/exercises/jumping-jack-gen.json',
    focus: ['full', 'cardio'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'squat-gen',
    name: 'Squat',
    file: '/lottie/exercises/squat-gen.json',
    focus: ['lower', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'pushup-gen',
    name: 'Push-Up',
    file: '/lottie/exercises/pushup-gen.json',
    focus: ['upper', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'high-knees-gen',
    name: 'High Knees',
    file: '/lottie/exercises/high-knees-gen.json',
    focus: ['cardio', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'shoulder-press-gen',
    name: 'Shoulder Press',
    file: '/lottie/exercises/shoulder-press-gen.json',
    focus: ['upper', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'plank-gen',
    name: 'Plank',
    file: '/lottie/exercises/plank-gen.json',
    focus: ['core', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'mountain-climber-gen',
    name: 'Mountain Climber',
    file: '/lottie/exercises/mountain-climber-gen.json',
    focus: ['core', 'cardio', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'burpee-gen',
    name: 'Burpee',
    file: '/lottie/exercises/burpee-gen.json',
    focus: ['full', 'cardio'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'lunge-gen',
    name: 'Lunge',
    file: '/lottie/exercises/lunge-gen.json',
    focus: ['lower', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
  {
    id: 'situp-gen',
    name: 'Sit-Up',
    file: '/lottie/exercises/situp-gen.json',
    focus: ['core', 'full'],
    creator: '75DaysLab',
    sourceUrl: '',
  },
...
export const ANIMATION_CREDITS = [
  ...
  {
    creator: '75DaysLab',
    pack: 'Custom Exercise Animations',
    url: 'https://github.com/mariamii13/75DaysLab',
  },
]
